...
export const servicePages: Record<string, ServicePage> = {
  "checkup/cancer": {
    ...
    introParagraphs: [
      ...
      "내포아산내과의원은 검진 전 준비부터 검사 후 결과 설명과 추적 계획까지 한 흐름으로 안내합니다."
    ],
  ...
  "checkup/employment": {
    ...
    introParagraphs: ["채용검진은 입사나 기관 제출을 위해 기본 건강 상태를 확인하는 검사입니다.", "제출 기관마다 요구 항목이 다를 수 있어 검진 전 필요한 서류와 항목 확인이 중요합니다.", "내포아산내과의원에서 시행 가능한 항목과 서류 발급 일정은 대표전화로 문의해 주세요."],
    symptomTitle: "준비사항",
  ...
  "vaccination": {
    ...
    introParagraphs: ["예방접종은 감염질환을 예방하고 합병증 위험을 낮추기 위한 중요한 예방 진료입니다.", "연령, 기저질환, 과거 접종력에 따라 필요한 접종이 달라질 수 있습니다.", "내포아산내과의원에서 접종 가능한 백신 항목은 대표전화로 문의해 주세요."],
  ...
  "special/iv-therapy": {
    ...
    introParagraphs: ["수액 치료는 환자 상태와 필요성을 확인한 뒤 시행해야 하는 치료입니다.", "기저질환, 복용약, 알레르기 등을 확인해 안전성을 먼저 평가합니다.", "내포아산내과의원의 수액 항목과 세부 구성은 대표전화로 문의해 주세요."],
